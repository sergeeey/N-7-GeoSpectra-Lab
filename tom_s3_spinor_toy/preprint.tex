...
The exact kernel count of this section, combined with the bundle isomorphism of
...
\item \textbf{Fermion mass hierarchy.} The index theorem gives $N_{\mathrm{gen}}=3$ with equal
  ...
  proves that all inter-generation Yukawa couplings are equal on $S^6$, so the mass
