...
\item \textbf{Non-perturbative origin of $\lambda$.} No geometric or spectral mechanism
  ...
  a $\rho_6$-dependent $e^{-\lambda/\rho_6^2}$ on the physical trajectory; one channel
  (wrapped-$S^3$ instantons) remains open and uncomputed. A complete moduli stabilization
  requires specifying the string background and computing $\lambda$ from first principles.
