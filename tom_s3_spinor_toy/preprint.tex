...
derivations (implemented as a Python/\texttt{sympy} test suite, 2488 tests: 2483
passing, 4 skipped, and 1 known pre-existing failure unrelated to this paper's
claims --- a naming-convention lint check in an unrelated experiment directory,
tracked separately),
