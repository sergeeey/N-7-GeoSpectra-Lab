...
\item \textbf{Full-operator zero-mode gap [REFUTED within the stated product
  ansatz --- blocking].} The three-channel construction above computes
  ...
  fixed --- not a further analysis of the $S^6$ factor alone.
